...
public class InvoiceSummary2 {
    ...
    public InvoiceSummary2(int userid ,int numberOfRides, double totalFare)
    {
        super();
    ...
    {
        return "InvoiceSummary2 [numberOfRides=" + numberOfRides + ", totalFare=" + totalFare + ", avarage=" + avarage
                + "]";
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        InvoiceSummary2 other = (InvoiceSummary2) obj;
